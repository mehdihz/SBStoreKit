...
typedef NS_ENUM(NSUInteger, SBKeychainQuerySynchronizationMode) {
    SBKeychainQuerySynchronizationModeAny,
    SBKeychainQuerySynchronizationModeNo,
    SBKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface SBKeychainQuery : NSObject
...
@property (nonatomic) SBKeychainQuerySynchronizationMode synchronizationMode;
#endif
