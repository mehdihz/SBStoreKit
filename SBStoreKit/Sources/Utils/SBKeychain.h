...
/**
 Error code specific to SBKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, SBKeychainErrorCode) {
    /** Some of the arguments were invalid. */
    SBKeychainErrorBadArguments = -1001,
};

/** SBKeychain error domain */
extern NSString *const kSBKeychainErrorDomain;

/** Account name. */
extern NSString *const kSBKeychainAccountKey;
 ...
 */
extern NSString *const kSBKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSBKeychainClassKey;

/** Item description. */
extern NSString *const kSBKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSBKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kSBKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSBKeychainWhereKey;
...
/**
 ...
 SBKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in SBKeychain.h for a list of keys that can be used when accessing the
